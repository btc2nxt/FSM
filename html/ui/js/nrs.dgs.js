...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.getMarketplacePurchaseHTML = function(purchase, showBuyer) {
		...
		if (purchase.unconfirmed) {
			...
			var currentTime = (new Date() - Date.UTC(2014, 5, 5, 6, 21, 19, 83)) / 1000;
	...
	NRS.forms.dgsPurchase = function($modal) {
		...
		data.deliveryDeadlineTimestamp = String(Math.floor((new Date() - Date.UTC(2014, 5, 5, 6, 21, 19, 83)) / 1000) + (60 * 60 * data.deliveryDeadlineTimestamp));
