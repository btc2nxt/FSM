...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_PROGRAMCODE = incorrect("programCode");
    public static final JSONStreamAware INCORRECT_CODE_SIZE = incorrect("programCodeSize");
    public static final JSONStreamAware INCORRECT_MACHINEDATA = incorrect("machineData");
    public static final JSONStreamAware INCORRECT_DATA_SIZE = incorrect("machineDataSize");
    public static final JSONStreamAware INCORRECT_STACK_SIZE = incorrect("machineStackSize");
    ...
    public static final JSONStreamAware INCORRECT_AUTOMATED_TRANSACTION_MACHINECODE_LENGTH = incorrect("machineCode", "(length must not exceed " + Constants.MAX_AUTOMATED_TRANSACTIONS_MACHINECODE_LENGTH + " bytes)");
    public static final JSONStreamAware INCORRECT_AUTOMATED_TRANSACTION_MACHINEDATA_LENGTH = incorrect("machineData", "(length must not exceed " + Constants.MAX_AUTOMATED_TRANSACTIONS_MACHINEDATA_LENGTH + " bytes)");
    public static final JSONStreamAware INCORRECT_AUTOMATED_TRANSACTION_STACK_LENGTH = incorrect("machineStackSize", "(length must not exceed" + Constants.MAX_AUTOMATED_TRANSACTIONS_STACK_LENGTH + " bytes");
