...
final class PeerImpl implements Peer {
    ...
    void setVersion(String version) {
        ...
        if (Nxt.APPLICATION.equals(application) && version != null) {
        	if (Constants.isTestnet ? version.startsWith("FSM-TESTNET-") : version.startsWith("NFD-")){
        			version=version.substring(Constants.isTestnet ? 12 : 4);
        	}
    ...
    void connect() {
        ...
        if (response != null) {
            ...
            if (analyzeHallmark(announcedAddress, (String)response.get("hallmark"))  && version!=null && ( Constants.isTestnet ? version.startsWith("FSM-TESTNET-") : version.startsWith("FSM-"))) {
