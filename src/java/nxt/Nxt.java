...
public final class Nxt {
    ...
    static {
        System.out.println("Initializing FSM server version " + Nxt.VERSION);
    ...
    public static void main(String[] args) {
    	VERSION = (Constants.isTestnet ? "FSM-TESTNET-" : "FSM-")+VERSION;
    ...
    public static void shutdown() {
        ...
        ThreadPool.shutdown();
        Db.shutdown();
        Logger.logShutdownMessage("FSM server " + VERSION + " stopped.");
        Logger.shutdown();
    }
    ...
    private static class Init {
        ...
        static {
            try {
            	...
            	Logger.logMessage("FSM server " + VERSION + " started successfully.");
